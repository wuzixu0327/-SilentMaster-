                    ...
                    <div class="col-xl-8 col-lg-7 col-md-12">
                        <div class="echo-hero-baner">
                            ...
                            if (!empty($_GET['id'])) {
                                // 'id' 参数存在且不为空
                                $id = $_GET['id'];
                                require_once('../../PhpSrc/Service/user_Match.php');
                                $show= new user_Match();
                                $showclass=$show->index_Match($id);
                            } else {
                                // 'id' 参数不存在或为空
                                echo '没有数据';
                            }
                                                ...
                                                <div class="main">
                                                    <div class="main-box">
                                                        ...
                                                        if (!empty($_GET['id'])) {
                                                            ...
                                                            require_once('../../PhpSrc/Service/user_Match.php');
                                                            $show= new user_Match();
                                                            $showclass=$show->Match_Massage($id);
                                                        } else {
                                                            // 'id' 参数不存在或为空
                                                            echo '没有数据';
                                                        }
                            ...
                            <div class="echo-popular-hl-img">
                                <div class="echo-home-2-title">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="echo-home-2-main-title">
                                                <h5 class="text-capitalize text-center">相关操作</h5>
                                                <div class="main">
                                                    <div class="main-box">
                                                        <br>
                                                        <?php
                                                        if (!empty($_GET['id'])) {
                                                            ...
                                                            if (isset($_SESSION['userSno'])) {
                                                                ...
                                                                $show= new user_Match();
                                                                $showclass=$show->Select_Join($id,$userSno);
                                                                if($showclass)
                                                                {
                                                                    echo '<a href="userSpace.php"><button type="button" style="width: 500px;position: relative;top: 20px;background: #0a53be;height: 50px;"><p style="color: white">查看我的队伍</p></button></a>';
                                                                }
                                                                else{
                                                                    echo '<a href="userSpace.php"><button type="button" style="width: 500px;position: relative;top: 20px;background: #0a53be;height: 50px;"><p style="color: white">创建队伍</p></button></a>';
                                                                }
                                                            } else {
                                                                // $_SESSION['userSno'] 不存在
                                                                echo '<a href="userlogin/userlogin.php"><button type="button" style="width: 500px;position: relative;top: 20px;background: #0a53be;height: 50px;"><p style="color: white">请先登录</p></button></a>';
                                                            }
                                                        } else {
                                                            // 'id' 参数不存在或为空
                                                            echo '没有数据';
