...
<div id="dcWrap">
    ...
    <div id="dcLeft"><div id="menu">
            ...
            <ul>
                <li class="cur"><a href="AdminTeam.php"><i class="theme"></i><em>参赛队伍</em></a></li>
    ...
    <div id="dcMain">
        ...
        <div id="urHere">管理中心<b>></b><strong>队伍列表</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
            <h3>参赛队伍管理</h3>
            <div class="filter">
                <form action="SelectAdminTeam.php" method="post" onsubmit="return getFormValues()">
            ...
            <div id="list">
                <form name="action" method="post" action="RankDelete.php">
                    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
                        <tr>
                            <th width="22" align="center"><input name='chkall' type='checkbox' id='chkall' onclick='selectcheckbox(this.form)' value='check'></th>
                            <th width="40" align="center">队伍ID</th>
                            <th align="left" width="300">队伍名称</th>
                            <th width="150" align="center">所属赛事</th>
                            <th width="80" align="center">赛事类型</th>
                            <th width="80" align="center">队伍规模</th>
                        ...
                        $selectTeam = new \Show_News\Match_infor();
                        // 存储 cat_id 到会话中
                        ...
                        if($keyword!=NULL){
                            $selectTeam->Selectinfo_keyword($keyword,$page,$cat_id);
                        }
                        else{
                            $selectTeam->Selectinfo_Nokeyword($cat_id,$page);
                        }
                        ?>
                    </table>
                    <div class="action">
            ...
            $Match = new \Show_News\Match_infor();
            if($keyword!=NULL){
               $number= $selectTeam->Page_keyword($keyword);
            }
            else{
                $number=$selectTeam->Page_Nokeyword($cat_id);
            }
            ...
            if ($page != 1) {
                echo '    <a href="SelectAdminTeam.php?upage=1">第一页</a>';
            }

            if ( $page - 1 > 0) {
                echo '    <a href="SelectAdminTeam.php?upage=' . ($page - 1) . '">上一页</a>';
            }

            if (intval(($number + 14) / 15) - $page > 0) {
                echo '    <a href="SelectAdminTeam.php?upage=' . ($page + 1) . '">下一页</a>';
            }

            if ($page != intval(($number + 14) / 15)) {
                echo '    <a href="SelectAdminTeam.php?upage=' . intval(($number + 14) / 15) . '">最后一页</a>';
            }
