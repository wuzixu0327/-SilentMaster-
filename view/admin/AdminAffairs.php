    ...
    <div id="dcHead">
        ...
        <div id="dcLeft"><div id="menu">
                ...
                <ul>
                    ...
                    <li class="cur"><a href="AdminAffairs.php"><i class="product"></i><em>学生事务管理</em></a></li>
        ...
        <div id="dcMain">
            <!-- 当前位置 -->
            <div id="urHere">管理中心<b>></b><strong>学生事务管理</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
                <h3>事务列表</h3>
                <div class="filter">
                    <input type="text" id="Select_News" placeholder="请输入事务名" size="50" class="inpMain" />
                    <input name="Select_botton" class="btnGray" type="button" value="搜索" onclick="checkSearchBox()"/>
                    <span>
        </span>
                </div>
                <div id="list">
                    <form method="post" action="../../PhpSrc/Controller/AffairsRevise.php?action=0" onsubmit="return validateForm()">
                        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
                            ...
                            use Show_News\Show_Affairs;

                            require_once('../../PhpSrc/Service/Show_Affairs.php');
                            if (isset($_GET['page'])) {
                                $page = $_GET['page'];
                            }
                            else {
                            ...
                            $show= new Show_Affairs();
                            $showclass=$show->Show_Affairs($page);
                            ?>
                        </table>
                        <div class="action">
                        ...
                        if ($page != 1) {
                            echo '    <a href="AdminAffairs.php?page=1">第一页</a>';
                        }

                        if ( $page - 1 > 0) {
                            echo '    <a href="AdminAffairs.php?page=' . ($page - 1) . '">上一页</a>';
                        }

                        if (intval(($number + 14) / 15) - $page > 0) {
                            echo '    <a href="AdminAffairs.php?page=' . ($page + 1) . '">下一页</a>';
                        }

                        if ($page != intval(($number + 14) / 15)) {
                            echo '    <a href="AdminAffairs.php?page=' . intval(($number + 14) / 15) . '">最后一页</a>';
                        }
            ...
            <script>
                function checkSearchBox() {
                    ...
                    if (searchBoxValue.trim() === "") {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "../../PhpSrc/Controller/AffairsRevise.php",
