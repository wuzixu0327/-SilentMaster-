...
<div id="dcWrap">
    ...
    <!-- dcHead 结束 -->
        <div id="dcLeft"><div id="menu">
                ...
                <ul>
                    <li class="cur"><a href="AdminNews.php"><i class="product"></i><em>新闻管理</em></a></li>
    ...
    <div id="dcMain">
        <!-- 当前位置 -->
        <div id="urHere">管理中心<b>></b><strong>新闻管理</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
            <h3>新闻列表</h3>
            <div class="filter">
                    <input type="text" id="Select_News" placeholder="请输入新闻名" size="50" class="inpMain" />
                    <input name="Select_botton" class="btnGray" type="button" value="搜索" onclick="checkSearchBox()"/>
                <span>
        </span>
            </div>
            <div id="list">
                <form method="post" action="../../PhpSrc/Controller/NewsRevise.php?action=0" onsubmit=" return validateForm()">
                    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
                        ...
                        require_once('../../PhpSrc/Service/Show_News.php');
                        if (isset($_GET['page'])) {
                            $page = $_GET['page'];
                        }
                        else {
                ...
                if ($page != 1) {
                    echo '    <a href="AdminNews.php?page=1">第一页</a>';
                }

                if ( $page - 1 > 0) {
                    echo '    <a href="AdminNews.php?page=' . ($page - 1) . '">上一页</a>';
                }

                if (intval(($number + 14) / 15) - $page > 0) {
                    echo '    <a href="AdminNews.php?page=' . ($page + 1) . '">下一页</a>';
                }

                if ($page != intval(($number + 14) / 15)) {
                    echo '    <a href="AdminNews.php?page=' . intval(($number + 14) / 15) . '">最后一页</a>';
                }
        ...
        <script>
            function checkSearchBox() {
                ...
                if (searchBoxValue.trim() === "") {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "../../PhpSrc/Controller/NewsRevise.php",
