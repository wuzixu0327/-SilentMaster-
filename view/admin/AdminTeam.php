...
<div id="dcWrap">
    ...
    <div id="dcMain">
        ...
        <div id="urHere">管理中心<b>></b><strong>队伍列表</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
            ...
            if ($page != 1) {
                echo '    <a href="AdminTeam.php?page=1">第一页</a>';
            }

            if ( $page - 1 > 0) {
                echo '    <a href="AdminTeam.php?page=' . ($page - 1) . '">上一页</a>';
            }

            if (intval(($number + 14) / 15) - $page > 0) {
                echo '    <a href="AdminTeam.php?page=' . ($page + 1) . '">下一页</a>';
            }

            if ($page != intval(($number + 14) / 15)) {
                echo '    <a href="AdminTeam.php?page=' . intval(($number + 14) / 15) . '">最后一页</a>';
            }
