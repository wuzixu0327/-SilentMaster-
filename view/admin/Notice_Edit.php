    ...
    <div id="dcMain">
        ...
        <div id="urHere">管理中心<b>></b><strong>信息修改</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
            ...
            <div class="idTabs">
                ...
                $TitleValue = $row['Notice_Title'] ?? null;
                $MassageValue = $row['Notice_Massage'] ?? null;
                ?>
                <div id="display">
                    <form action="../../PhpSrc/Controller/NoticeRevise.php" method="post" enctype="multipart/form-data">
                        <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="Notice_Edittitle" size="80" class="inpMain" value="
                                         <?php
                                    echo $TitleValue;
                                    echo '"/>';
                                    ?>
                                ...
                                <td>
                                    ...
                                    <script>
                                        KindEditor.ready(function(K) {
                                            var editor1 = K.create('textarea[name="Notice_Editmassage"]', {
                                    ...
                                    <!-- /KindEditor -->
                                    <textarea id="content" name="Notice_Editmassage" style="width:780px;height:400px;" class="textArea" >
                                            <?php
                                            echo $MassageValue;
                                            ?>
                                        </textarea>
