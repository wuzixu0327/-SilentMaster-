    ...
    <div id="dcMain">
        ...
        <div id="urHere">管理中心<b>></b><strong>信息发布</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
            ...
            <div class="idTabs">
                ...
                ?>
                        <div id="display">
                            <form action="../../PhpSrc/Controller/NewsRevise.php" method="post" enctype="multipart/form-data">
                            <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="news_Edittitle" size="80" class="inpMain" value="
                                         <?php
                                        echo $TitleValue;
                                        echo '"/>';
                                        ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="file" enctype="multipart/form-data" name="news_Edithref" size="18" value="
                                         <?php
                                           echo $hrefValue;
                                           echo '"/>';
                                         ?>
                                    ...
                                    <td>
                                        ...
                                        <script>
                                            KindEditor.ready(function(K) {
                                                var editor1 = K.create('textarea[name="news_Editmassage"]', {
                                        ...
                                        <!-- /KindEditor -->
                                        <textarea id="content" name="news_Editmassage" style="width:780px;height:400px;" class="textArea" >
                                            <?php
                                            echo $MassageValue;
                                            ?>
                                        </textarea>
