...
class user_Notice
{
    public function NoticeShow($ID){
        ...
        try{
            $sqlData = "SELECT * FROM web_notice where Notice_ID = $ID";
            $resultData = $conn->query($sqlData);
            while ($row = $resultData->fetch_assoc()) {

                echo '<div class="echo-inner-img-ct-1  img-transition-scale">';
                echo '<a><img src="';
                echo '../../PhpSrc/Controller/News/Notice.png"';
    ...
    public function Notice_Massage($ID){
        require_once "../../PhpSrc/PhpMysql/PDOMysql.php";
        require_once "../../PhpSrc/PhpMysql/MysqlMassage.php";
        $database = new PDOMysql();
        $conn = $database->getConnection();
    ...
    public function Show_Notice(){
        ...
        $conn = $database->getConnection();
        try{
            $News_sql = "SELECT * FROM web_notice order by Notice_ID desc limit 0,3";
            ...
            while ($row = $resultData->fetch_assoc()) {
                ...
                echo '<a href="userNotice_show.php?id=';
                echo $row['Notice_ID'];
                echo '">';
                echo ' <img src="';
                echo '../../PhpSrc/Controller/News/Notice.png"';
                ...
                echo '<h6><a href="userNotice_show.php?id=';
                echo $row['Notice_ID'];
